...
Clone this repo and add `bin/` to your PATH, or copy `bin/git-sync` and `lib/`
into your project.
...
This installs a pre-commit hook that snapshots repo state, and a post-merge hook
that syncs after pull.
